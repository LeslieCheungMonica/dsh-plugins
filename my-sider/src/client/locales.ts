...
export const zh = {
  ...
  'shell.clear': '清屏',
  'shell.runs': '运行记录',
  'shell.empty': '还没有命令记录。在下面输入一条命令并回车。',
  'shell.waiting': '命令正在执行…',
  'shell.noOutput': '这条命令没有输出。',
  'shell.dir': '工作目录',
  'shell.dir.hint': '命令在这个目录下执行；默认取当前会话所在项目，留空则用宿主的默认目录。',
...
export const en = {
  ...
  'shell.clear': 'Clear',
  'shell.runs': 'Runs',
  'shell.empty': 'No commands yet. Type one below and press Enter.',
  'shell.waiting': 'The command is running…',
  'shell.noOutput': 'This command produced no output.',
  'shell.dir': 'Working directory',
  'shell.dir.hint': 'Commands run here; it defaults to the current session\u2019s project. Empty means the host\u2019s own directory.',
